...
console.log(
  fe.deep(new Map().set('foo', new Map().set('bar', 'baz')), new Map().set('foo', new Map().set('bar', 'baz')))
);
console.log(
  fe.shallow(new Map().set('foo', new Map().set('bar', 'baz')), new Map().set('foo', new Map().set('bar', 'baz')))
);
